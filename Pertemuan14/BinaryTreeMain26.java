public class BinaryTreeMain26 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Cari mahasiswa denagn ipk: 3.54 : ");
        String hasilCari = bst.find(3.54)?"Ditemukan":"Tidak ditemukan";
        System.out.println(hasilCari);

        System.out.print("Cari mahasiswa denagn ipk: 3.22 : ");
        ...
        Mahasiswa26 minMhs = bst.cariMinIPK();
        if (minMhs != null) {
        ...
        Mahasiswa26 maxMhs = bst.cariMaxIPK();
        if (maxMhs != null) {
